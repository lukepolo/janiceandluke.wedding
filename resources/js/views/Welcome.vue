<template>
    ...
    <h1 class="primary">
      <span>C</span><span class="left-o">o</span><span class="left-m">m</span><span class="left-e">e</span>
      <div class="break-space"></div>
      <span>C</span><span class="left-e">e</span><span>l</span><span class="left-e">e</span><span>b</span><span>r</span><span>a</span><span class="left-t">t</span><span class="left-e">e</span><span class="left-ex">!</span>
    </h1>
  ...
  <section class="section travel">
    <div class="section--content">
      <h1 class="secondary">Travel<br>&<br><span class="heading-small">Accommodations</span></h1>
      ...
      <div class="travel--img">
        ...
        <div class="travel--img-text">
          ...
          <p>
            ...
            <br>
            <a href="http://oakwoodresort.com" target="blank" class="a-inverse">oakwoodresort.com</a>
          </p>
        </div>
      </div>

      <p>
        The resort hotel is reserved for the wedding. To reserve a room in our block, call the Oakwood and reference
        you are part of the Falotico/Policinski wedding.
      </p>
    ...
    <div class="section--content">
      ...
      <div class="registry--list">
        <div class="registry--item">
          <svg id="svg-icon-logo-cb-large" viewBox="0 0 219 32" width="100%" height="100%">
        ...
        <div class="registry--item">
          <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMaxYMax" viewBox="0 0 32 32" height="40" width="40" focusable="false" class="Icon-sc-19f81vv-0 ikHKrY">
            <g>
              <path fill="#000" d="M16 0C7.2 0 0 7.2 0 16s7.2 16 16 16 16-7.2 16-16S24.8 0 16 0m0 26.7c-5.9 0-10.8-4.9-10.8-10.8S10.1 5 16 5s10.7 4.9 10.7 10.8S21.9 26.7 16 26.7"></path>
              <path fill="#000" d="M16 10.5c-3 0-5.5 2.4-5.5 5.5s2.4 5.5 5.5 5.5 5.5-2.4 5.5-5.5-2.5-5.5-5.5-5.5"></path>
            </g>
          </svg>
          <span style="font-family:'helvetica'; font-weight:bold; font-size: 38px; letter-spacing: -1.5px; padding-left: 10px;">target</span>
        </div>
      </div>
